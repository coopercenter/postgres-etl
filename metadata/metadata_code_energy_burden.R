...
energy_burden_county_expenditures_units <- 'dollar'
energy_burden_county_percent_income_units <- 'percent'
...
r1<- data.frame(db_table_name = "energy_burden_by_fuel_type", 
                ...
                column2variable_name_map=I(energy_burden_by_fuel_type_cols),units=I(energy_burden_by_fuel_type_units),frequency=NA,
...
r2<- data.frame(db_table_name = "energy_burden_county_expenditures",
                ...
                column2variable_name_map=I(energy_burden_county_expenditures_cols),units=I(energy_burden_county_expenditures_units),frequency=NA,
                data_source_brief_name='LEAD',data_source_full_name='Low-Income Energy Affordability Data Tool',
                url='https://www.energy.gov/eere/slsc/maps/lead-tool',api=NA,
                series_id=NA,json=NA,notes=NA, data_type='cross-sectional', data_context='historical', 
                corresponding_data=NA, 
...
r3<- data.frame(db_table_name = "energy_burden_county_percent_income",
                ...
                column2variable_name_map=I(energy_burden_county_percent_income_cols),units=I(energy_burden_county_percent_income_units),frequency=NA,
                data_source_brief_name='LEAD',data_source_full_name='Low-Income Energy Affordability Data Tool',
                url='https://www.energy.gov/eere/slsc/maps/lead-tool',api=NA,
                series_id=NA,json=NA,notes=NA, data_type='cross-sectional', data_context='historical', 
                corresponding_data=NA, 
