...
r1 <- data.frame(db_table_name = "VCEA_energy_efficiency",
                ...
                data_source_brief_name='UVA ELC', data_source_full_name='Environmental Legislative Clinic at the University of Virginia',
                url=NA, api=NA, series_id=NA,json=NA, 
                notes= NA, 
                mandate=0, forecast=1, corresponding_data=NA, R_script='cleaning_VCEA_goals.R')
