...
dbWriteTable(db, 'co2_emissions_by_source_va', co2_emissions, row.names=FALSE, overwrite = TRUE)
dbWriteTable(db, 'no_emissions_by_source_va', nitrogen_emissions, row.names=FALSE, overwrite = TRUE)
dbWriteTable(db, 'so2_emissions_by_source_va', sulfur_emissions, row.names=FALSE, overwrite = TRUE)
#close db connection
dbDisconnect(db)